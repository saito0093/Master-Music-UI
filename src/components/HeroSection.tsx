  ...
  return (
    <div className='h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0'>
       ...
       <div className='p-4 relative z-10 w-full text-center'>
         ...
         <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">Dive into our comprehensive music courses and transform your musical journey today. Whether you are a beginner or a seasoned musician, our courses are designed to empower you with the knowledge and skills to excel in the world of music.</p>
         <div className='mt-4'>
            <Link href ={"/courses"}>
               <Button 
